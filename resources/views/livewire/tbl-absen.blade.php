                        ...
                        @foreach ($karyawan as $d)
                            <tr>
                                ...
                                @for ($i = 1; $i <= $totalTgl; $i++)
                                    ...
                                    @endif
                                @endfor
                                <td class="bg-light">{{ $this->getTotal($d->id, 'M') }}</td>
                                <td class="bg-light">{{ $this->getTotal($d->id, 'E') }}</td>
                                <td class="bg-light">{{ $this->getTotal($d->id, 'SP') }}</td>
                                <td class="bg-light">
                                    {{ $totalTgl - $this->getTotal($d->id, 'M') + $this->getTotal($d->id, 'E') + $this->getTotal($d->id, 'SP') }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
